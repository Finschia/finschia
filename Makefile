...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/docs/statik/statik.go" | xargs goimports-reviser -rm-unused -format -set-alias -company-prefixes "github.com/Finschia/"
