...
func TestFnsadExport(t *testing.T) {
	db := dbm.NewMemDB()
	logger := log.NewTestLogger(t)
	gapp := NewFnsaAppWithCustomOptions(t, false, SetupOptions{
	...
	newGapp := NewFnsaApp(logger, db, nil, true, simtestutil.NewAppOptionsWithFlagHome(t.TempDir()), emptyWasmOpts)
